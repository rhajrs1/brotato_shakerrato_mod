...
# Called from:
#   res://mods-unpacked/Darkly77-ExpandedChallenges/extensions/main.gd
#   res://mods-unpacked/Darkly77-ExpandedChallenges/extensions/singletons/run_data.gd
func extch_check_custom_completion_challenges(won_ron:bool = false)->void:
	for challenge in challenges:
		# if challenge is ExpandedChallengeData:
		if challenge is preload("res://mods-unpacked/Darkly77-ExpandedChallenges/challenges/ex_challenge_data.gd"):
			var _unlocked = _extch_check_single_custom_challenge(challenge, true, won_ron)


# Accepts a custom challenge resource (ExpandedChallengeData/ex_challenge_data.gd)
#   challenge = ExpandedChallengeData
